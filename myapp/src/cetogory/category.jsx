...
export default function Category_data({hendleModal_close}){
    return(
        <div className="overlay_category">
        {cat_list.map(el=>(<Link to={`/${el.cat_name}`} onClick={()=>hendleModal_close()} ><Cat_com cat_icon={el.cat_logo}  cat={el.cat_name}/></Link>))}
